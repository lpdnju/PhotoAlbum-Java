# Charter — Default Modernization Playbook

## Metadata

- **Name:** `azure-app-modernization-default`
- **Description:** Default playbook for modernizing .NET and Java applications to Azure App Service, Container Apps, or AKS
...
Of the 6R strategies, this playbook covers **Rehost**, **Replatform**, and **Refactor** — the three that involve app modernization. Retire, Retain, and Repurchase are outside the scope of app modernization.
