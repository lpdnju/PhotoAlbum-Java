...
- **use-defaults** (Optional): When `true`, read the built-in default playbook files as reference to fill gaps in the generated playbook. User source takes priority when there is a conflict. Default files: [charter-default](references/charter-default.md), [targets-default](references/targets-default.md), [policies-default](references/policies-default.md)
...
- **charter.md** — Playbook metadata (name, version), scope (covered applications, languages constraints), 6R modernization strategy (Rehost / Replatform / Refactor decision table with override conditions — Retire, Retain, Repurchase are outside app modernization scope), and guiding principles. Loaded during assessment and plan creation to determine what to modernize and what strategy to apply.
...
2. If ${use-defaults} is `true`, read the default playbook files ([charter-default](references/charter-default.md), [targets-default](references/targets-default.md), [policies-default](references/policies-default.md)) as reference context. When the user source and a default conflict, the user source takes priority.
