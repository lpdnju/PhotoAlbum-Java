...
# ── Fact tabs catalog ────────────────────────────────────────────────────────
FACT_TABS = [
    ("tab-arch", "Architecture", "How the app's layers connect — from UI to data.", "architecture.md"),
    ("tab-api", "API Contracts", "Endpoints exposed by this app and how services communicate.", "api-contracts.md"),
    ("tab-config", "Configuration", "Environment settings, runtime profiles, and deployment manifests.", "configuration.md"),
    ("tab-workflows", "Business Workflows", "Domain entities and the core flows users move through.", "business-workflows.md"),
    ("tab-deps", "Dependencies", "Libraries and frameworks this app depends on, grouped by category.", "dependencies.md"),
    ("tab-data", "Data Model", "Database schema, entity relationships, and persistence behavior.", "data-model.md"),
]
